...
interface ThreadCardProps {
    ...
    onToggleFav: (threadNumber: string) => void;
}
        ...
        <>
            ...
            {threadIsHidden ? (<div className="flex justify-between items-center">
                ...
                <div>
                    ...
                    <div className={`flex gap-3 mt-2 right-2 items-center top-2 to-thread-link ${isMobile ? 'mb-3 justify-center' : 'justify-end'}`}>
                        <span className={`text-black dark:text-white cursor-pointer `} onClick={() => {onToggleFav(thread.num.toString())}}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill={`${threadIsFaved ? 'currentColor' : ''}`} viewBox="0 0 24 24" strokeWidth={1.5}
